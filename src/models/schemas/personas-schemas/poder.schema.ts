...
import { AntecedenteFiduciarioSchema, DropDownGroupSchema, DropDownItemSchema } from "./catalogos.schema"
...
export const AntecedenteSchema = new Schema({
    ...
    // Para antecedentes de constitución
